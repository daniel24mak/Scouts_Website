...
VALUES
  ...
  ('finance.workspace.access', 'standard', false),
  ('finance.transactions.view', 'standard', false),
  ('finance.transactions.create', 'elevated', false),
  ('finance.transactions.post', 'high', true),
  ('finance.transactions.reverse', 'high', true),
  ('finance.accounts.view', 'standard', false),
  ('finance.funds.view', 'standard', false),
  ('finance.group_budget.view', 'standard', false),
  ('finance.budgets.view', 'standard', false),
  ('finance.budgets.manage', 'elevated', false),
  ('finance.purchases.view', 'standard', false),
  ('finance.purchases.create', 'elevated', false),
  ('finance.reimbursements.view', 'standard', false),
  ('finance.reimbursements.create', 'elevated', false),
  ('finance.collections.view', 'standard', false),
  ('finance.collections.manage', 'elevated', false),
  ('finance.reconciliation.view', 'elevated', false),
  ('finance.reconciliation.manage', 'high', true),
  ('finance.periods.view', 'standard', false),
  ('finance.reports.view', 'elevated', false),
  ('finance.settings.manage', 'high', true),
  ('finance.files.manage', 'elevated', false),
  ...
  ('storage.workspace.access', 'standard', false),
  ('storage.inventory.view', 'standard', false),
  ('storage.movements.create', 'elevated', false),
  ('storage.restricted_locations.view', 'elevated', false),
  ('storage.requests.view', 'standard', false),
  ('storage.requests.create', 'standard', false),
  ('storage.requests.submit', 'standard', false),
  ('storage.requests.reserve', 'elevated', false),
  ('storage.loans.view', 'standard', false),
  ('storage.loans.manage', 'elevated', false),
  ('storage.loans.receive', 'elevated', false),
  ('storage.restocking.view', 'standard', false),
  ('storage.suppliers.view', 'standard', false),
  ('storage.suppliers.manage', 'elevated', false),
  ('storage.deliveries.manage', 'elevated', false),
  ('storage.maintenance.view', 'standard', false),
  ('storage.maintenance.create', 'standard', false),
  ('storage.audits.view', 'elevated', false),
  ('storage.audits.manage', 'elevated', false),
  ('storage.audits.approve', 'high', true),
  ('storage.reports.view', 'elevated', false),
  ('storage.settings.manage', 'high', true),
