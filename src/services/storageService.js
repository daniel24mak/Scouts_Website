...
export async function uploadGalleryImage(albumId, file) {
  ...
  return uploadSupabaseFile(optimizedImagePath(`gallery/optimized/${albumId}`, file), optimized.file, "gallery");
}
...
export async function uploadSiteImage(contentKey, file) {
  ...
  return uploadSupabaseFile(optimizedImagePath(`site-images/optimized/${contentKey}`, file), optimized.file, "site-images");
}
...
export async function uploadLeaderHeadshot(leaderId, file) {
  ...
  return uploadSupabaseFile(optimizedImagePath(`leader-headshots/optimized/${leaderId || "new"}`, file), optimized.file, "leader-headshots");
}
